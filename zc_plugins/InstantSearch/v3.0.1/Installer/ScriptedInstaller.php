    ...
    protected function createConfigurationSettings(int $configurationGroupId): void
    {
        ...
        $sql = "
            ...
            VALUES
                ...
                ('[Typesense] Host', 'INSTANT_SEARCH_TYPESENSE_HOST', 'typesense', 'Typesense Host', $configurationGroupId, now(), 2300, NULL, NULL, NULL),
                ...
                ('[Typesense] Key', 'INSTANT_SEARCH_TYPESENSE_KEY', 'Ffuz6GfmAkDsNzKexGRf2tni4wivhTMq', 'Typesense Key', $configurationGroupId, now(), 2600, NULL, NULL, '{\"error\":\"ERROR\",\"id\":\"FILTER_SANITIZE_URL\",\"options\":{\"options\":{}}}')
        ";
        $this->executeInstallerSql($sql);
    }
